  ...
  return (
    <div className="animate-pulse space-y-6">
      <div className="space-y-2">
        ...
        <div className="h-4 w-72 rounded bg-panel2" />
      </div>
      <div className="overflow-x-auto rounded-xl border border-rail bg-panel">
        <div className="border-b border-rail bg-panel2 px-5 py-3.5">
          <div className="flex gap-8">
            ...
            <div className="ml-auto h-3 w-16 rounded bg-panel" />
            <div className="h-3 w-16 rounded bg-panel" />
            <div className="h-3 w-10 rounded bg-panel" />
          </div>
        </div>
        <div className="divide-y divide-rail">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
            <div key={i} className="flex items-center gap-4 px-5 py-3.5">
              ...
              <div className="ml-auto h-4 w-8 rounded bg-panel2" />
