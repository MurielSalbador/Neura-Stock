  ...
  return (
    <div className="animate-pulse space-y-6">
      <div className="space-y-2">
        <div className="h-8 w-40 rounded-lg bg-panel2" />
        <div className="h-4 w-52 rounded bg-panel2" />
      </div>
      <div className="h-24 rounded-xl border border-rail bg-panel p-5">
        ...
        <div className="divide-y divide-rail">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="flex items-center gap-4 px-5 py-4">
              ...
              <div className="ml-auto h-4 w-24 rounded bg-panel2" />
